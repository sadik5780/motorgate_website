...
export default function ServiceDetailsPage({ params }) {
    ...
    const servicesData = {
        "maintenance": {
            ...
            description: "Vehicle servicing and repairs by trusted workshops—book a convenient slot, track progress in real time, get updates, and pay only after completion.",
                        ...
                        <div className="reviews-swiper-container px-0">
                            ...
                            >
                                {(activeReviewTab === 'users' ? [
                                    { name: "Ali Salem", role: "Toyota Camry", text: "Lorem Ipsum Is Simply Dummy Text Of The Printing And Typesetting Industry. Lorem Ipsum Has Been The Industry's Standard Dummy Text Ever Since The 1500s,", img: "/img/profile.jpg" },
                                    { name: "Bella Zhang", role: "Honda Accord", text: "An Innovative Sedan Known For Its Reliability And Performance, Making It A Top Choice Among Drivers.", img: "/img/profile.jpg" },
                                    { name: "Carlos Mendez", role: "Ford Fusion", text: "With Sleek Design And Advanced Tech Features, This Car Combines Style With Functionality.", img: "/img/profile.jpg" },
                                    { name: "Diana Lee", role: "Nissan Altima", text: "A Popular Mid-Size Sedan That Offers Excellent Fuel Efficiency And A Comfortable Ride For Families.", img: "/img/profile.jpg" },
                                    { name: "John Doe", role: "Chevrolet Malibu", text: "Reliable and efficient service. I highly recommend this workshop for regular maintenance.", img: "/img/profile.jpg" }
                                ] : [
                    ...
                    <div className="max-w-[1200px] mx-auto px-6">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                            ...
                            <div>
                                ...
                                <h2 className="text-[32px] font-bold text-[#1a1a1a] mb-6">
                                    Get In Touch With Us
                                </h2>
                                <p className="text-gray-500 mb-8 leading-relaxed">
                                    Have questions or need assistance? We are here to help you. Reach out to us via phone or fill out the form below.
                                </p>

                                <div className="flex items-center gap-4">
                                    <div className="w-12 h-12 bg-blue-50 rounded-full flex items-center justify-center text-[#2388FF]">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-xl font-bold text-[#1a1a1a]">+966 123456789</div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <form className="space-y-5">
                                    <div>
                                        <input
                                            ...
                                            className="w-full px-4 py-3 rounded-xl bg-gray-50 border border-gray-100 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white transition-all placeholder:text-gray-400"
                                        />
                                    </div>
                                    <div>
                                        <input
                                    ...
                                    <div>
                                        <textarea
                                            ...
                                            className="w-full px-4 py-3 rounded-xl bg-gray-50 border border-gray-100 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white transition-all placeholder:text-gray-400 resize-none"
                                        ></textarea>
                                    </div>
                                    <button
                                        type="button"
                                        className="w-full py-3.5 rounded-xl bg-[#2388FF] text-white font-semibold text-sm hover:bg-blue-600 transition-colors shadow-lg shadow-blue-500/20"
                                    >
                                        Send Message
                                    </button>
                                </form>
                    ...
                    <div className="relative z-10 max-w-[1200px] mx-auto px-6 py-16">
                        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-12">
                            ...
                            <div>
                                ...
                                <p className="text-sm">Motor Gate, Jeddah 23617, Saudi Arabia</p>
                            </div>
